...
function Content() {
  ...
  return (
    <Container className="fluid" id="Main">
      <MissionCard animate="fade-right" heading="Our Mission" content="Our Mission is to make a safer Environment for the living of Elder
      ...
      <div className="Request">
        <CustomCard animate="flip-left" Image={Money} heading="Fund Donation" content=" Please feel free to donate the smallest amount of money for the
        ...
        <CustomCard animate="flip-right" Image={Blood} heading="Blood Donation" content="Donate Blood at your nearest place. Your Donated Blood could save
      ...
      <CommunityCard animate="fade-left" heading="Community" content="We are a Growing Community of large amount of people and other
