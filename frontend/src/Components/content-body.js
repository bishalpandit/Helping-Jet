...
import { Navbar, Carousel, CarouselItem, Nav, Container, Row, Col, Card, Button, Image, CardImg, CardDeck, CardGroups, CardColumns } from 'react-bootstrap'
    ...
    return (
        <Container className="fluid" id="Main">
            ...
            <div className="Request">
                <Card className="col-lg-4 bg-light text-dark" >
                    ...
                    <CardColumns className="Request-Content">
                        <p>
                            Please feel free to donate the smallest amount of money for the cause of Elders, it can impact many lives and can help the ones in need.
                        </p>
                    </CardColumns>
                    <CardDeck>
                        <a href="https://pages.razorpay.com/pl_I2YcFN8rBp9lEC/view"><button type="button" className="btn btn-lg btn-primary" >Donate</button></a>
                    </CardDeck>
                </Card>
                <Card className="col-lg-4 bg-light text-dark" >
                    ...
                    <CardColumns className="Request-Content">
                        <p>
                            Donate Blood at your nearest place. Your Donated Blood could save a life,  Be a saviour and Donate your blood for the people in need.
                        </p>
                    </CardColumns>
                    <CardDeck>
            ...
            <div className="About">
                ...
                <div className="Work">
                    ...
                    <Card className="col-lg-4 bg-light text-dark" >
                        ...
                        <CardColumns className="Request-Content">
                            <p>
                                We provide support to Elders financially, medically and socically by connecting to their nearest NGO and our Volunteers inspects the working of the NGO once in a week
                                and also supplies medicines and Ration.
                            </p>
                        </CardColumns>
                    </Card>
                    <Card className="col-lg-4 bg-light text-dark" >
            ...
            <Carousel id="Review" className="bg-primary">
                ...
                <CarouselItem className="items text-light" >
                    <p>The volunteers and members of this team comes to our Old Age House to Meet us every month </p>
